...
<p>After obtaining my Ph.D. and working as a C++ developer for 18 months, I have worked as a freelance engineering consultant writing embedded C++ code and processing big data (<a href="https://be.linkedin.com/in/brechtmachiels" title="Brecht Machiels on LinkedIn">LinkedIn</a>). I have also spent over 12 months working full-time on rinohtype in order to bring it to the level of commercial typesetting software.</p>
